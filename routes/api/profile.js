...
router.get("/", async (req, res) => {
  try {
    //using populate to get fields from user collection, a different collection
...
router.get("/user/:user_id", async (req, res) => {
  try {
    ...
    console.error(err.message);
    // send profile not found message if not a valid user ID, rather than server error message
...
router.delete("/", auth, async (req, res) => {
  try {
    // remove user posts
    await Post.deleteMany({ uder: req.user.id });
